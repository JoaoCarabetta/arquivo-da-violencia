"""Validate dedup-cluster fixture files."""

from __future__ import annotations

from eval.schemas import ValidationResult
from eval.schemas_dedup import DedupClusterFixture, validate_dedup_cluster_fixture


def validate_fixture(fixture: DedupClusterFixture) -> ValidationResult:
    return validate_dedup_cluster_fixture(fixture)


def labeled_cases(fixture: DedupClusterFixture):
    return [
        c
